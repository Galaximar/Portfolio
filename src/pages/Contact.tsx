...
const Contact: React.FC = () => {
  ...
  const faqs = [
    ...
    {
      question: "faq_availability_question",
      answer: "faq_availability_answer",
    },
          ...
          <div className={styles.grid}>
            <div className={styles.formSide}>
              <div className={styles.card}>
                <h3>
                  <Icon name="mail" /> {t("send_me_a_message")}
                </h3>
                <form
                ...
                >
                  ...
                  {statusMessage && (
                    <span
                      className={`${styles.formFeedback} ${statusClassName}`}
                      role="status"
                    >
                      {statusMessage}
                    </span>
                  ...
                  <span className={styles.formNote}>
                    <Icon name="sun" /> {t("form_secure_note")}
                  </span>
                </form>
              </div>
            </div>
              ...
              <div className={styles.directContact}>
                ...
                <div className={styles.contactList}>
                  ...
                  <div className={styles.contactItem}>
                    ...
                    <a
                      href="https://linkedin.com/in/marcelogottardini/"
                      target="_blank"
