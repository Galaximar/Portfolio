...
It also has an administrative panel, in which you can:<br/>Create/edit/delete a category, product,<br/>ban a user, convert user to admin, view transactions.</p>,role:"FullStack Developer.",tecnologies:{Frontend:["React","Redux","Css","Material UI","Sass","Nodemailer"],Backend:["Express","Sequelieze","Node","JWT","Firebase"],Database:["PostgreSQL"]}};
const weather={deploy:"https://weatherappclime.vercel.app/",title:"Weather App",date:"Dec '1-2021",image:"https://static01.nyt.com/images/2014/12/11/technology/personaltech/11machin-illo/11machin-illo-superJumbo-v3.jpg",description:<p>A simple Weather app, with forecast and data graphs</p>,role:"Frontend Developer.",tecnologies:{Frontend:["Javascript","React","Css","Bootstrap","Google Charts","Material UI","Local Storage"]}};
...
const data=[
  everyoneStore,foodApi,weather,blackJack
]
export default function Body() {
  ...
  useEffect(()=>{
    setRefs([aboutRef.current,projectsRef.current,tecnologiesRef.current,footerRef.current])
  },[])
  return (
      ...
      <div ref={projectsRef}>
      <Typography variant="h3" sx={{color:"white"}}>Projects</Typography>
