...
export default withWidth()(function Form({ width, t }) {
  ...
  const validate = () => {
    setError({
      ...error,
      submit:
        data.mail && data.motive && data.description && error.mail === false,
    });
  };
  const submit = () => {
    const config = {
  ...
  return (
    ...
    >
      <div className={`${!(width === "sm" || width === "xs") && style.mail}`}>
        <div>
          ...
          <TextField
            ...
            name="mail"
            id="outlined-error"
            label={<span style={{ color: "white" }}>Mail</span>}
        ...
        <div>
          ...
          <TextField
            ...
            label={<span style={{ color: "white" }}>{t("motivo")}</span>}
      ...
      <TextField
        ...
        label={<span style={{ color: "white" }}>{t("descripcion")}</span>}
      ...
      <div
        className={`${
          !(width === "sm" || width === "xs") ? style.button : style.cel
        }`}
      >
        <LoadingButton
          loading={loading}
          ...
          sx={{
            height: "50px",
            boxShadow: "none",
            borderRight: "6px solid #00e6f6",
            mt: "10px",
            background: `${
              error.submit
                ? "linear-gradient(45deg, transparent 5%, #4caf50 5%)"
            ...
            "&:hover": {
              ...
              background: `${
                error.submit
                  ? "linear-gradient(45deg, transparent 5%, #2e7d32 5%)"
                  : "linear-gradient(45deg, transparent 5%, #ff013c 5%)"
              }`,
            },
          }}
